...
#gender by stimulus, new focused data set
...
menonly= barspread[barspread[['author_gender']] == 'male'&barspread[['author_orient']] == 'heterosexual'&barspread[['author_audience']] == 'woman',]
womenonly= barspread[barspread[['author_gender']] == 'female'&barspread[['author_orient']] == 'heterosexual'&barspread[['author_audience']] == 'man',]
gaymenonly= barspread[barspread[['author_gender']] == 'male'&barspread[['author_orient']] == 'homosexual'&barspread[['author_audience']] == 'man',]
gaywomenonly= barspread[barspread[['author_gender']] == 'female'&barspread[['author_orient']] == 'homosexual'&barspread[['author_audience']] == 'woman',]

tt=rbind(menonly, womenonly)
tt=rbind(gaymenonly, gaywomenonly)
barspread= rbind(menonly, womenonly,gaymenonly, gaywomenonly)
...
colnames(g)= c('Emoticons', 'Prosody', 'Control')
g= g[,c('Control', 'Emoticons', 'Prosody')]
...
f= f[,c('Control', 'Prosody', 'Clippings')]
